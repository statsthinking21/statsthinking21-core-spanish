...
4. Ajusta el modelo a los datos que representen la hipótesis alternativa y calcula un estadístico de prueba.
...
Esta fórmula nos dará un resultado igual a $n_1 + n_2 - 2$ cuando las varianzas y los tamaños de muestras sean iguales; de otra manera será un resultado menor, aplicando una penalización sobre la prueba debido a las diferencias en los tamaños de muestra o varianzas.  Para este ejemplo, el resultado es `r I(sprintf("%0.2f", welch_df))` grados de libertad, que es ligeramente menor que el valor de 248 que obtendríamos si restamos 2 a la suma de los tamaños de muestra.
...
- [Mindless Statistics, por Gerd Gigerenzer](https://library.mpib-berlin.mpg.de/ft/gg/GG_Mindless_2004.pdf)
