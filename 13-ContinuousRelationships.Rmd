...
#library(BayesMed)
# library(MCMCpack) # Used by jzs function in BayesMed
# library(R2jags) # Used by jzs function in BayesMed
library(cowplot)
library(knitr)
library(DiagrammeR)
library(htmltools)
