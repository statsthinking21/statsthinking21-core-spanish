...
---
<!--# Working with data-->
# Trabajar con Datos {#working-with-data}
...
Other
Counts of the prevalence of different responses to the question "Why are you taking this class?"
...
classData=data.frame(why=c("Satisface un requisito de mi plan de estudios",
                           "Satisface un requisito de General Education Breadth",
                           "No es requisito, pero estoy interesadx en el tema",
                           "Otros"),
                     nResponses=c(105,32,11,4))

knitr::kable(
  classData, booktabs = TRUE,
  caption = 'Conteos de la prevalencia de diferentes respuestas a la pregunta "¿Por qué estás tomando esta clase"',
  col.names=c('¿Por qué estás tomando esta clase?',"Número de estudiantes")
)
```
...
```{r ReliabilityValidity, echo=FALSE,fig.cap="Una figura mostrando la diferencia entre confiabilidad y validez, usando tiros al blanco. Confiabilidad se refiere a la consistencia de la localización de los tiros, y validez se refiere a la precisión con que los tiros quedaron respecto al centro de las dianas.",fig.width=6,fig.height=6,out.height='33%'}
...
- [*An Introduction to Psychometric Theory with Applications in R*](http://www.personality-project.org/r/book/) - Un libro de texto gratuito en línea sobre medición psicológica.
...
- *Cero absoluto*: La escala tiene un verdadero punto cero significativo. Por ejemplo, para muchas mediciones de cantidades físicas como la altura o el peso, este es la ausencia total de la cosa que está siendo medida. 
...
<!-- Different scales of measurement admit different types of numeric operations -->
<!-- Equal/not equal -->
<!-- Multiply/divide -->
...
measTypes=data.frame(equal=c('OK','OK','OK','OK'),
                     ...
                     addsub=c('','','OK','OK'),
                     multdiv=c('','','','OK'),
                     row.names=c('Nominal','Ordinal','Intervalo','Razón'))
knitr::kable(
  measTypes, booktabs = TRUE,
  caption = 'Diferentes escalas de medición admiten diferentes tipos de operaciones numéricas.',
  col.names=c("Igual/No igual",">/<", "+/-", "Multiplicar/dividir")
)
