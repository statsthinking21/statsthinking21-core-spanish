...
<!-- fig.cap="Examples of random numbers generated from a uniform (left) or normal (right) distribution." -->
```{r rngExamples,echo=FALSE, fig.cap="Ejemplos de números aleatorios generados a partir de una distribución uniforme (izquierda) y normal (derecha).",fig.width=8,fig.height=4,out.height='50%'}
...
<!-- fig.cap="Simulated finishing time distributions." -->
```{r finishingTimes, echo=FALSE,fig.cap="Distribuciones de simulaciones de tiempos de término del examen.",fig.width=8,fig.height=4,out.height='50%'}
...
<!-- fig.cap="Distribution of maximum finishing times across simulations." -->
```{r finishTimeSim,echo=FALSE,fig.cap="Distribución de tiempos máximos de finalización de examen a lo largo de diferentes simulaciones.",fig.width=4,fig.height=4,out.height='50%'}
