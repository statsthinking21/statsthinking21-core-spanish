...
install.packages('magick', repos='https://cloud.r-project.org/', dependencies=TRUE)
...
if (!require("janitor")) install.packages("janitor",repos="https://cran.rstudio.com",dependencies=TRUE)
...
if (!require("StanHeaders")) install.packages("StanHeaders",repos="https://cran.rstudio.com",dependencies=TRUE)
...
if (!require("bayestestR")) install.packages("bayestestR",repos="https://cran.rstudio.com",dependencies=TRUE)
